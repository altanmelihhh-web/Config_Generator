            ...
            sections: [
                ...
                },
                {
                    ...
                    fields: [
                        ...
                        { name: 'mask', why: "Maske karşı uçla aynı olmalı; uyuşmazlık durumunda cihaz bazı komşuları doğrudan bağlı görmez, bunun yerine gateway'e yönlendirir ve trafik gereksiz yere dolaşır veya kaybolur.", label: 'Subnet Mask', type: 'text', validate: 'netmask', required: true, placeholder: '255.255.255.0', hint: 'Noktalı ondalık subnet maskesi' },
