            ...
            sections: [
                {
                    ...
                    icon: 'fas fa-map-signs',
                    fields: [
                        { name: 'dest', label: 'Hedef Ağ', type: 'text', validate: 'ip', required: true, placeholder: '10.100.0.0', hint: 'Default route için 0.0.0.0', why: "Hedef ağın host bitleri sıfır olmalıdır; VRP maskeyle hizalı olmayan adresi kabul eder ama maskeyle keserek kaydeder, sonuçta tabloda beklediğinizden farklı bir önek görürsünüz." },
