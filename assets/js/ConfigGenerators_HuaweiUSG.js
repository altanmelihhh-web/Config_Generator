            ...
            sections: [
                {
                    ...
                    fields: [
                        ...
                        { name: 'mask', why: "Maske noktalı desimal yazılır. Bir bit hata gateway adresinin subnet dışında kalmasına ve tüm yönlendirmenin sessizce çalışmamasına yol açar; USG bu durumda hata vermez, sadece paketleri düşürür.", label: 'Subnet Mask', type: 'text', validate: 'netmask', required: true, placeholder: '255.255.255.0', hint: 'Subnet mask (noktalı desimal formatında)' },
