            ...
            sections: [
                ...
                },
                {
                    ...
                    fields: [
                        ...
                        { name: 'subnet', why: "Maske karşı uçtakiyle <b>birebir</b> aynı olmalıdır; /24 yerine /25 gibi dar bir maske girilirse aynı fiziksel segmentteki bazı hostlar komşu değil uzak ağ sayılır ve erişilemez.", label: 'Subnet Mask', type: 'text', validate: 'netmask', required: true, placeholder: '255.255.255.0', hint: 'Noktalı ondalık subnet mask' },
