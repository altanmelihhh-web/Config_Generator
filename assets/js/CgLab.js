...
const CgLab = {
    ...
    VENDORS: {
        ...
        paloalto: { name: 'Palo Alto PAN-OS', look: 'PAN-OS 11.1 (PA-VM)', levels: ['CLI temelleri', 'Kurulum, arayüzler ve yönetim', 'Nesneler, kurallar ve yapılandırma yönetimi', 'NAT, yönlendirme ve güvenlik profilleri', 'Doğrulama ve yüksek erişilebilirlik', 'Sorun giderme', 'Sınav tarzı'], engine: () => (typeof CgLabSetCli !== 'undefined' ? CgLabSetCli.panos : null), files: ['assets/js/lab/core.js', 'assets/js/lab/setcli.js', 'assets/data/labs/paloalto.js', 'assets/data/labs/paloalto-yol.js'] },
