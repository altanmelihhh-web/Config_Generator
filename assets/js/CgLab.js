...
const CgLab = {
    ...
    VENDORS: {
        ...
        'f5-ltm': { name: 'F5 BIG-IP', look: 'TMOS 17.1 (BIG-IP VE)', levels: ['CLI temelleri (bash ve tmsh)', 'Kurulum ve yönetim erişimi', 'Trafik: virtual server, pool, monitor', 'Persistence, SNAT ve profiller', 'Operasyon: log, yedek, yükseltme ve HA', 'Sorun giderme', 'Sınav tarzı', 'iRule: programlanabilir trafik'], engine: () => (typeof CgLabTmsh !== 'undefined' ? CgLabTmsh : null), files: ['assets/js/lab/core.js', 'assets/js/lab/irule.js', 'assets/js/lab/tmsh.js', 'assets/data/labs/f5.js'] },
