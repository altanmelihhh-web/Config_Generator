...
const CgLab = {
    ...
    VENDORS: {
        ...
        huawei: { name: 'Huawei VRP', look: 'VRP V200R (S5700 / AR)', levels: ['CLI temelleri (görünümler)', 'Kurulum ve yönetim erişimi', 'L2 temelleri ve yönetim sertleştirme', 'Servisler, L2 güvenlik ve yönlendirme', 'ACL ve yedeklilik', 'Sorun giderme', 'Sınav tarzı'], engine: () => (typeof CgLabVrp !== 'undefined' ? CgLabVrp : null), files: ['assets/js/lab/core.js', 'assets/js/lab/vrp.js', 'assets/data/labs/huawei.js'] },
        ...
        paloalto: { name: 'Palo Alto PAN-OS', look: 'PAN-OS 11.1 (PA-VM)', levels: ['CLI temelleri', 'Kurulum, arayüzler ve yönetim', 'Nesneler, kurallar ve yapılandırma yönetimi', 'NAT ve güvenlik profilleri', 'Kural doğrulama', 'Sorun giderme', 'Sınav tarzı'], engine: () => (typeof CgLabSetCli !== 'undefined' ? CgLabSetCli.panos : null), files: ['assets/js/lab/core.js', 'assets/js/lab/setcli.js', 'assets/data/labs/paloalto.js', 'assets/data/labs/paloalto-yol.js'] },
        checkpoint: { name: 'Check Point', look: 'Gaia R81.20', levels: ['Gaia clish temelleri', 'Kurulum, arayüzler ve sağlık', 'Yönetim, log ve yedekleme', 'Yönlendirme ve NAT', 'ClusterXL ve VPN', 'Sorun giderme', 'Sınav tarzı'], engine: () => (typeof CgLabGaia !== 'undefined' ? CgLabGaia : null), files: ['assets/js/lab/core.js', 'assets/js/lab/gaia.js', 'assets/data/labs/checkpoint.js', 'assets/data/labs/checkpoint-yol.js'] },
    },
