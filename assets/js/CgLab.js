...
const CgLab = {
    ...
    VENDORS: {
        ...
        juniper: { name: 'Juniper Junos', look: 'Junos 23.4 (EX/SRX/MX)', levels: ['CLI temelleri', 'Temel sistem ve uzaktan yönetim', 'Arayüz, anahtarlama ve servisler', 'Güvenlik ve yönlendirme', 'SRX, filtre ve yedeklilik', 'Sorun giderme', 'Sınav tarzı'], engine: () => (typeof CgLabSetCli !== 'undefined' ? CgLabSetCli.junos : null), files: ['assets/js/lab/core.js', 'assets/js/lab/setcli.js', 'assets/data/labs/juniper.js'] },
