...
(function () {
    ...
    root.CG_LAB_PATHS = [
        ...
        { id: 'f5-adc', vendor: 'f5-ltm', title: 'F5 BIG-IP: sıfırdan üretime', desc: 'Boş bir BIG-IP\'yi ilk kurulumdan uygulama yayınına, operasyona, HA\'ya ve arıza teşhisine adım adım üretime hazırlayın (F5-CAB hedefleriyle).',
          modules: ADC({ 1: ['f5-01'], 2: ['f5-02'], 3: ['f5-03'], 4: ['f5-04'], 5: ['f5-09'], 6: ['f5-06'], 7: ['f5-07'], 8: ['f5-08', 'f5-23', 'f5-24'], 9: ['f5-14'], 10: ['f5-13'], 11: ['f5-11'], 12: ['f5-15'], 13: ['f5-05', 'f5-10', 'f5-12', 'f5-16'], 14: ['f5-17', 'f5-18'], 15: ['f5-30', 'f5-31', 'f5-32', 'f5-33', 'f5-34', 'f5-35'] }) },
