...
(function () {
    ...
    root.CG_LAB_PATHS = [
        ...
        { id: 'checkpoint-fw', vendor: 'checkpoint', title: 'Check Point: sıfırdan üretime', desc: 'Gaia gateway\'ini clish ile kurulumdan ClusterXL\'e ve arıza teşhisine adım adım üretime hazırlayın. Politika SmartConsole\'da yazılır; burada gateway tarafı çalışılır.',
          modules: FW({ 1: ['cp-01', 'cp-02'], 2: ['cp-08'], 3: ['cp-21'], 4: ['cp-09', 'cp-23'], 5: ['cp-13', 'cp-24', 'cp-25'], 7: ['cp-17', 'cp-20'], 8: ['cp-18'], 9: ['cp-14', 'cp-26', 'cp-27'], 10: ['cp-28'], 12: ['cp-10', 'cp-06', 'cp-22', 'cp-35', 'cp-36'], 13: ['cp-07'], 15: ['cp-11', 'cp-29'], 16: ['cp-05'], 17: ['cp-03', 'cp-04', 'cp-19', 'cp-12', 'cp-15', 'cp-16'] },
              { 1: 'clish ve expert, show/set, save config; arayüz ve rota.', 7: 'Katman katman sınama (link, ping, ip route get, tcpdump); ARP, ip neigh ve Proxy ARP (fw ctl arp).', 8: 'Rota seçimi: en uzun önek, show route destination, daha özel statik rota.', 2: 'İzinli istemciler, oturum zaman aşımı, parola politikası, roller.', 3: 'Gaia DHCP sunucusu: alt ağ, havuz, süreç; ağ geçidi ve DNS.', 4: 'VLAN alt arayüzleri, bond (802.3ad) ve SmartConsole topolojisi / Security Zone.', 5: 'mgmt_cli ile nesne ve kural; publish ve install-policy.', 9: 'Nesnede otomatik Hide NAT ve fw monitor ile doğrulama.', 12: 'Saat dilimi, uzak syslog, sağlık kontrolü; lisans, WatchDog, SecureXL ve CoreXL durumu.', 13: 'vpn tu ve IKE günlüğüyle faz 1/faz 2 teşhisi.', 15: 'save configuration, backup ve snapshot.', 16: 'ClusterXL durumu ve kontrollü failover.', 17: 'zdebug drop, kernel debug (fw ctl debug/kdebug), fw monitor, tcpdump (TCP bayrakları), rota ve kural arızaları.' }) },
