...
(function () {
    ...
    root.CG_LAB_PATHS = [
        ...
        { id: 'checkpoint-fw', vendor: 'checkpoint', title: 'Check Point: sıfırdan üretime', desc: 'Gaia gateway\'ini clish ile kurulumdan ClusterXL\'e ve arıza teşhisine adım adım üretime hazırlayın. Politika SmartConsole\'da yazılır; burada gateway tarafı çalışılır.',
          modules: FW({ 1: ['cp-01', 'cp-02'], 2: ['cp-08'], 4: ['cp-09'], 12: ['cp-10', 'cp-06'], 13: ['cp-07'], 15: ['cp-11'], 16: ['cp-05'], 17: ['cp-03', 'cp-04', 'cp-12'] },
              { 1: 'clish ve expert, show/set, save config; arayüz ve rota.', 2: 'İzinli istemciler, oturum zaman aşımı, parola politikası, roller.', 4: 'VLAN alt arayüzleri ve SmartConsole topolojisi.', 12: 'Saat dilimi, uzak syslog ve sağlık kontrolü.', 13: 'vpn tu ve IKE günlüğüyle faz 1/faz 2 teşhisi.', 15: 'save configuration, backup ve snapshot.', 16: 'ClusterXL durumu ve kontrollü failover.', 17: 'zdebug drop, fw monitor, tcpdump ve rota arızaları.' }) },
